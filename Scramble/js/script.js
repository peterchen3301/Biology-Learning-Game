...
document.getElementById("levels").onclick = function() {
    swal({
        ...
        html:"<br>" +
            '<button id="buttonEasy" class="btn btn-primary btn-lg">EASY</button>' +
            '<button id="buttonMedium" class="btn btn-primary btn-lg">MEDIUM</button>'+
            '<button id="buttonHard" class="btn btn-primary btn-lg">HARD</button>',
